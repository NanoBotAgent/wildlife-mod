...
public class MeerkatEntity extends Animal {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob parent) {
        return WildlifeEntities.MEERKAT.create(level, EntitySpawnReason.BREEDING);
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath("minecraft", "block.sand.step")), 0.15F, 1.5F);
    }
