...
public class WildlifeModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(WildlifeEntities.FOX,
            ctx -> new WildlifeMobRenderer<>(ctx, new FoxModel(ctx.bakeLayer(WildlifeModelLayers.FOX)), 0.4F, "fox"));
        ...
        EntityRendererRegistry.register(WildlifeEntities.GOAT,
            ctx -> new WildlifeMobRenderer<>(ctx, new GoatModel(ctx.bakeLayer(WildlifeModelLayers.GOAT)), 0.5F, "goat"));
        ...
        EntityRendererRegistry.register(WildlifeEntities.BEE,
            ctx -> new WildlifeMobRenderer<>(ctx, new BeeModel(ctx.bakeLayer(WildlifeModelLayers.BEE)), 0.15F, "bee"));
