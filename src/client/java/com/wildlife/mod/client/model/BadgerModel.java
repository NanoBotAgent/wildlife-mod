...
/**
 * Badger model - low-slung quadruped with broad body and distinctive face stripes.
 */
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition body = root.addOrReplaceChild("body",
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-4.0F, -4.0F, -8.0F, 8.0F, 5.0F, 14.0F, CubeDeformation.NONE),
            PartPose.offset(0.0F, 17.0F, 0.0F));

        body.addOrReplaceChild("head",
            CubeListBuilder.create()
                .texOffs(0, 19)
                .addBox(-3.0F, -3.0F, -5.0F, 6.0F, 4.0F, 5.0F)
                .texOffs(22, 19)
                .addBox(-2.0F, -0.5F, -7.0F, 4.0F, 2.0F, 2.0F), // snout
        ...
        body.addOrReplaceChild("tail",
            CubeListBuilder.create()
                .texOffs(0, 28)
                .addBox(-1.0F, -1.5F, 0.0F, 2.0F, 3.0F, 4.0F),
