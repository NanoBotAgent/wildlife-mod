...
/**
 * Boar model - stocky quadruped with large head and tusks.
 */
public class BoarModel extends EntityModel<WildlifeRenderState> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition body = root.addOrReplaceChild("body",
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-5.0F, -7.0F, -10.0F, 10.0F, 8.0F, 18.0F, CubeDeformation.NONE),
            PartPose.offset(0.0F, 12.0F, 0.0F));

        body.addOrReplaceChild("head",
            CubeListBuilder.create()
                .texOffs(0, 26)
                .addBox(-4.0F, -4.0F, -8.0F, 8.0F, 6.0F, 8.0F)
                .texOffs(32, 26)
                .addBox(-2.0F, -1.0F, -10.0F, 4.0F, 3.0F, 2.0F) // snout
                .texOffs(48, 26)
                .addBox(-3.0F, -1.0F, -6.0F, 1.0F, 2.0F, 1.0F) // left tusk
                .texOffs(48, 26)
                .addBox(2.0F, -1.0F, -6.0F, 1.0F, 2.0F, 1.0F), // right tusk
        ...
        body.addOrReplaceChild("tail",
            CubeListBuilder.create()
                .texOffs(56, 0)
                .addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F),
    ...
    public void setupAnim(WildlifeRenderState state) {
        ...
        this.rightFrontLeg.xRot = (float)(Math.sin(walkAnim * 0.6F) * 0.6F * limbSwing);
        this.leftFrontLeg.xRot = (float)(Math.sin(walkAnim * 0.6F + Math.PI) * 0.6F * limbSwing);
        this.rightHindLeg.xRot = (float)(Math.sin(walkAnim * 0.6F + Math.PI) * 0.6F * limbSwing);
        this.leftHindLeg.xRot = (float)(Math.sin(walkAnim * 0.6F) * 0.6F * limbSwing);

        this.tail.yRot = (float)(Math.sin(state.ageInTicks * 0.4F) * 0.2F);
