...
/**
 * Deer model - graceful quadruped with slender body, long legs, and antlers.
 */
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition body = root.addOrReplaceChild("body",
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-5.0F, -8.0F, -14.0F, 10.0F, 9.0F, 22.0F, CubeDeformation.NONE),
        ...
        body.addOrReplaceChild("head",
            CubeListBuilder.create()
                ...
                .texOffs(28, 0)
                .addBox(-1.5F, -1.0F, -8.0F, 3.0F, 3.0F, 2.0F) // snout
                .texOffs(0, 14)
                .addBox(-4.0F, -8.0F, -3.0F, 1.0F, 4.0F, 1.0F) // left antler
                .texOffs(0, 14)
                .addBox(3.0F, -8.0F, -3.0F, 1.0F, 4.0F, 1.0F), // right antler
        ...
        body.addOrReplaceChild("right_front_leg",
            ...
            PartPose.offset(-3.0F, 1.0F, -8.0F));
