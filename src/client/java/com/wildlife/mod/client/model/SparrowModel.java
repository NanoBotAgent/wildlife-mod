 ...
 * Sparrow model.
 */
public class SparrowModel extends EntityModel<WildlifeRenderState> {
    ...
    public static LayerDefinition createLayerDefinition() {
        ...
        body.addOrReplaceChild("tail",
            CubeListBuilder.create().texOffs(0, 10).addBox(-1.5f, -1.0f, 0, 3f, 2f, 3f),
    ...
    public void setupAnim(WildlifeRenderState state) {
        ...
        this.body.y = 20f + (float)(Math.abs(Math.sin(wa*1.2f))*0.5f*ls);

        // Wing flutter
        this.rightWing.zRot = (float)(Math.sin(age*3.5f)*0.2f) + 0.1f;
        this.leftWing.zRot = (float)(Math.sin(age*3.5f+Math.PI)*0.2f) - 0.1f;
