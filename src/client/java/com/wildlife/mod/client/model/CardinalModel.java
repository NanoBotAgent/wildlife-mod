...
/**
 * Cardinal model - medium songbird with a prominent crest and short thick beak.
 */
public class CardinalModel extends EntityModel<WildlifeRenderState> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        body.addOrReplaceChild("head",
            CubeListBuilder.create()
                ...
                .texOffs(18, 13)
                .addBox(-1.0F, -0.5F, -6.0F, 2.0F, 1.5F, 2.0F) // short thick beak
                .texOffs(26, 13)
                .addBox(-1.5F, -5.0F, -2.0F, 3.0F, 2.0F, 2.0F), // crest
